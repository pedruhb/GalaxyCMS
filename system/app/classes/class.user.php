	...
	public static function userData($key)
	{
		...
		if (loggedIn()) {
			if ($config['hotelEmu'] == 'arcturus') {
				if (in_array($key, array('activity_points', 'vip_points', 'gotw_points'))) {
					switch ($key) {
											...
											if (!self::emailTaken($_POST['email'])) {
												if (strlen($_POST['password']) >= 6) {
													if ($_POST['password'] == $_POST['password_repeat']) {
														...
														echo $lang['Rsenharepet'];
														return;
													}
												} else {
													echo $lang['Rsenhashort'];
													return;
												}
											} else {
												echo $lang['Remailusado'];
												return;
											}
										} else {
											echo $lang['Ruserusado'];
											return;
										}
									} else {
										echo $lang['Remailinvalido'];
										return;
									}
								} else {
									echo $lang['Remailbranco'];
									return;
								}
							} else {
								echo $lang['Rrepetisenha'];
								return;
							}
						} else {
							echo $lang['Rsenhabranco'];
							return;
						}
					} else {
						echo $lang['Rusuariobranco'];
						return;
					}
				} else {
					echo $lang['Rusuariobranco'];
