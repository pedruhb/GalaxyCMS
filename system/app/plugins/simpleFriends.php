<?php
	...
	function friendList()
	{
		...
		$getRelations1 = $dbh->prepare("SELECT * FROM messenger_friendships WHERE relation = '1' AND user_one_id = :id ORDER BY RAND()");
		...
		$getUser->bindParam(':targetId', $infoRelations1['user_two_id']);
		$getUser->execute();
		...
		if($infoRelationsNum == '0'){
			...
			You have no friends in this category!
		...
		$getRelations1 = $dbh->prepare("SELECT * FROM messenger_friendships WHERE relation = '2' AND user_one_id = :id ORDER BY RAND()");
		$getRelations1->bindParam(':id', $_SESSION['id']);
		$getRelations1->execute();
		$infoRelations1 = $getRelations1->fetch();
		$infoRelationsNum = $getRelations1->rowCount();
		...
		$getRelations1 = $dbh->prepare("SELECT * FROM messenger_friendships WHERE relation = '3' AND user_one_id = :id ORDER BY RAND()");
		$getRelations1->bindParam(':id', $_SESSION['id']);
		$getRelations1->execute();
		$infoRelations1 = $getRelations1->fetch();
		$infoRelationsNum = $getRelations1->rowCount();
