			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="mt-0 header-title">Emblemas</h4>
								<p class="text-muted mb-3">Visualize os emblemas hospedados no hotel.</p>
								<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									<tbody>
										<?php
										$pegaJson = file_get_contents($config['galaxyApiUrl'] . "/emblemas_hospedados.php?api=" . $config['galaxyApiKey']);
										$json = json_decode($pegaJson);
										foreach ($json as $emblema => $valor) {
											echo '<tr>
											<td><img src="' .	$config['badgeURL'] . '/' . $valor->codigo . '.gif"></td>
											<td>' . $valor->codigo . '</td>
											<td>' . $valor->nome . '</td>
