			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="mt-0 header-title">Usuários do IP: <?=  $_GET['ip'];?></h4>
								<p class="text-muted mb-3">Visualize e gerencie aqui os usuários fakes..</p>
								<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									<tbody>
										<?php
										$getArticles = $dbh->prepare("SELECT * FROM users WHERE ip_last = :ip order by id desc limit 1000");
										$getArticles->bindParam(':ip', $_GET['ip']);
										$getArticles->execute();
