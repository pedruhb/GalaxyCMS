			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="mt-0 header-title">Chatlogs</h4>
								<p class="text-muted mb-3">Veja os chatlogs do hotel, limitado aos últimos 5 mil.</p>
								<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									<tbody>
										<?php
										$obtemLogs = $dbh->prepare("SELECT chatlogs_room.message, chatlogs_room.timestamp, chatlogs_room.room_id, users.username, rooms.name FROM chatlogs_room, users, rooms WHERE chatlogs_room.message != '' AND users.id = chatlogs_room.user_from_id AND rooms.id = chatlogs_room.room_id ORDER BY chatlogs_room.timestamp DESC LIMIT 2500");
										$obtemLogs->execute();
