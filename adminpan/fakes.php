			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="mt-0 header-title">Usuários com contas fakes</h4>
								<p class="text-muted mb-3">Visualize os usuários que tem mais de uma conta por ip.</p>
								<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									<tbody>
										<?php
										$getArticles = $dbh->prepare("SELECT *, COUNT(id) AS Qtd FROM users GROUP BY ip_last HAVING COUNT(id) > 1 ORDER BY COUNT(id) DESC");
										$getArticles->execute();
										while($result = $getArticles->fetch()){
											...
											<td><a href="/adminpan/contasip/'.$result['ip_last'].'">'.$result['Qtd'].'</a></td>
