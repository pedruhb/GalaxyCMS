			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h4 class="mt-0 header-title">Paylogs</h4>
								<p class="text-muted mb-3">Veja os paylogs do hotel, limitado aos últimos 5 mil.</p>
								<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									<tbody>
										<?php
										$obtemLogs = $dbh->prepare("SELECT phbplugin_paylogs.valor, phbplugin_paylogs.currency, phbplugin_paylogs.time, envia.username AS envia, recebe.username AS recebe FROM phbplugin_paylogs,users envia, users recebe WHERE recebe.id = phbplugin_paylogs.user_recebe AND envia.id = phbplugin_paylogs.user_envia ORDER BY phbplugin_paylogs.id DESC");
										$obtemLogs->execute();
										while ($log = $obtemLogs->fetch()) {
										?>
											<tr>
												<td class="text-primary"><?= $log['envia']; ?></td>
												<td class="text-primary"><?= $log['recebe']; ?></td>
												<td class="text-primary"><?= $log['valor']; ?></td>
												<td class="text-primary"><span class="badge badge-pill badge-primary-light"><?= $log['currency']; ?></span></td>
